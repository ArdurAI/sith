...
| E7 | Governed MCP server | P3 | E2, E4, E5, E6 |
| E8 | Operator console / UI | P1 thin → P3 | E2, E5, E6 |
| E9 | Deployment & packaging | M0 → P3 | E0 |
...
flowchart LR
    ...
    subgraph P1["P1 — Read federation"]
        E1["E1 Tenancy & identity"]
        E2["E2 Read federation"]
        E8["E8 Operator console (thin read)"]
    ...
    subgraph P3["P3 — Policy federation + MCP"]
        E7["E7 Governed MCP server"]
    end
